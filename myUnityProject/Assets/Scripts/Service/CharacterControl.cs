...
namespace Service
{
    ...
    public class CharacterControl : MonoBehaviour
    {
        ...
        {
            char_cust_info.eye = int.Parse(value.text);
        }
        //TODO
        public void SetHair(Text value)
        {
            char_cust_info.hair = int.Parse(value.text);
        }
        //TODO
        public void SetNose(Text value)
        {
            char_cust_info.nose = int.Parse(value.text);
        }
        //TODO
        public void SetMouth(Text value)
        {
            char_cust_info.mouth = int.Parse(value.text);
        }
    }
}